...
## $$Bar Graphs for 2010 and 2017$$

We begin our visualization of this trend with two barplots- one for 2010 and one for 2017. These barplots show how many border apprehensions there were for each sector in each year. Our graphs below demonstrate that the number of apprehensions greatly vary by sector, and the sector that had the highest number of border apprehensions differed between 2010 and 2017.  
